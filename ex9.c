/***************************************************************************
 *   ex9.c                                    Version 20230204.093431      *
 *                                                                         *
 *   imprimir uma arvore com 25 numeros aleatorios                         *
 *   em inorder, preorder e posorder.                                      *
...
#define VERSION "20230204.093431" /* Version Number (string) */
#endif
...
int main(void)
{
    /* local declarations */
    int i; /* general index */
    int n = 0; /* variavel para alocar os numeros gerados aleatoriamente */
    arvore *raiz = NULL; /* raiz da arvore */
